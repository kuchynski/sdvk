...
public:
    ...
    QList<QString> GetLineText(const unsigned &n);
    QString GetPoleText(const unsigned &l, const unsigned &n);
    ...
    int GetNumberActivLine() {return number_checked_line;}
    void Paint();
private:
...
signals:
    ...
    void ClickDoubleLine(unsigned n);
    void IAmReSize();
