...
CAllWindows::CAllWindows(QWidget *parent) : buttons(this),
    QWidget(parent), tek(0), new_tek(0), timer_id(0), mouse_press(false), enabled_mouse(false)
{
...
void CAllWindows::SetInitStruct(const SAllWindowsInit &set_struct)
{
    ...
    if(init_struct.direction_frame == SAllWindowsInit::edVertical)
    {
        ...
        buttons.setMaximumHeight(100000);
        buttons.SetInitStruct(but_init);
        box_layout->setDirection(QBoxLayout::LeftToRight);
        buttons.setVisible(true);
    }
    else if(init_struct.direction_frame == SAllWindowsInit::edHorizontal)
    {
        ...
        buttons.setMaximumWidth(100000);
        buttons.SetInitStruct(but_init);
    ...
    {
        buttons.setMaximumHeight(0);
        buttons.setMaximumWidth(0);
...
void CAllWindows::SetVisibleWidget(const unsigned n)
{
    OnButtonsClick(n, false);
}
unsigned CAllWindows::GetVisibleWidget() const
{
...
void CAllWindows::mouseMoveEvent(QMouseEvent *pe)
{
    ...
    if(mouse_press)
    {
        ...
        else if(init_struct.direction_widget == SAllWindowsInit::edHorizontal)
        {
